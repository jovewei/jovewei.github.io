...
- 币安智能链Binance Smart Chain: [Bscscan](https://www.bscscan.com/)
- Solana链: [Solanascan](http://solanascan.io/)、[Solana FM](https://solana.fm/)
- Polygon: [polygonscan](https://polygonscan.com/)
- xDAI: [Gnosis Chain Explorer](https://blockscout.com/xdai/mainnet/)
- Metis链: [Andromeda Metis Explorer](https://andromeda-explorer.metis.io/)
- Arbitrum: [Arbiscan](https://arbiscan.io/)
- Aptos: [Aptos explorer](https://explorer.aptoslabs.com/?network=mainnet)、[Aptoscan](https://aptoscan.com/)
- Sui: [Suiexplorer](https://suiexplorer.com/)、[Suiscan](https://suiscan.xyz/)
- Optimistic: [Optimistic](https://optimistic.etherscan.io/)
- Avalanche: [Avalanche](https://snowtrace.io/)
...
![Untitled](/images/posts/blockchain_sec/tools_4.png)

以上是 ETH 转账成功的显示内容。那么除了 ETH，代币（Token）的交易信息是怎样的呢? 我们这里以转账 KyberNetwork 为例

![Untitled](/images/posts/blockchain_sec/tools_3.png)
...
![Untitled](/images/posts/blockchain_sec/tools_5.png)
...
![Untitled](/images/posts/blockchain_sec/tools_10.png)

区块链浏览器同样提供API服务，感兴趣的同学可以参考如下链接：

[Etherscan API中文手册 - 汇智网](http://cw.hubwiz.com/card/c/etherscan-api/)

## 交易分析工具

- [Tenderly](https://dashboard.tenderly.co/)
- [Openchain](https://openchain.xyz/trace)
- [Blocksec phalcon](https://phalcon.blocksec.com/explorer)
...
- [Interview Contracts](https://github.com/HalbornSecurity/InterviewContracts)
- [Pinball Challenge](https://rinkeby.etherscan.io/address/0xffb9205c84d0b209c215212a3cdfc50bf1cfb0e0#code)
...
- [Hacking smart contracts for fun and profit](https://gist.github.com/seresistvanandras/b66d3fd8c7681e8643e77ef8c5b9f634)
- [Challenges by @robot_dreams](https://twitter.com/robot__dreams/status/1479518204036669441)

**CTFs**

- [Sherlock CTF Solutions](https://github.com/sherlock-protocol/sherlock-ctf-0x0)
...
- [非小号](https://www.feixiaohaozh.info/)
